...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(" số sách giáo khoa: ");
        soSachGiaoKhoa = scanner.nextInt();
        System.out.print(" số sách tham khảo: ");
        ...
        System.out.println("Trung bình cộng đơn giá sách giáo khoa = " + trungBinhCongDonGia);        
        System.out.println(" sách giáo khoa của nhà xuất bản");
        for (int i = 0; i < arrSachGiaoKhoa.size(); i++) {
